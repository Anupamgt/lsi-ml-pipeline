...
These rasters follow the factor list in Sonker et al. (2022) and sit on a common **30 m** grid (EPSG:32646, extent 461520, 2578020, 521610, 2700000). They are **inputs**. A 17-factor Frequency Ratio LSI has **not** been computed from them.
...
|---|---|---|---|---|---|
| 1 | Rainfall | Prepared (continuous) | `S17_01_Rainfall_CHIRPS_mm.tif` | CHIRPS mean annual mm, complete years 2010–2018 (GEE), warped to 30 m | Paper used IMD 1988–2018. Not yet 5-classed for FR |
...
| 10 | Gravity | Prepared (continuous) | `S17_10_Gravity_Bouguer_mGal.tif` | GGMPlus gravity minus 0.1119 × elevation (simple Bouguer) | Optional in the paper (digitised Sikkim map). Not yet 5-classed |
...
## What would change a 17-factor FR
...
- **Rainfall / gravity:** 5-class (quantile or Jenks) before FR.
- **Inventory:** more than 22 points before a 70/30 ROC is meaningful.
